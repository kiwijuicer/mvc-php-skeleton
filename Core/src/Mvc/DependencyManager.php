...
use Core\Log\Logger;
use Core\Mvc\Exception\ClassNotFoundException;
...
class DependencyManager implements ContainerInterface
{
     ...
     * @param string $name
     * @return mixed
     * @throws \Core\Mvc\Exception\ClassNotFoundException
     */
    public function get($name)
    {
        ...
        if (array_key_exists($name, $this->managers)) {
            ...
            /** @var \Core\Manager\AbstractManager $manager */
            $manager = new $managerConfig['manager'](Db::getConnection(Application::getConfig()['db'], $managerConfig['db']));
